...
const PDFComportamientos = ({ DATOS, anios, datosUsuario }) => {
  ...
  return (
          ...
          <View style={styles.colums}>
           <View style={styles.colums}>
            ...
            <View style={styles.rowsbetween}>
              <Text style={styles.txtBody}>{`${pre.NOMBRE} ${pre.APELLIDOS}`}</Text>
              <View>
                <View
                  style={{
                    display:"flex",
    ...
    color: "#5e615c",
    marginBottom: "5",
  }}>{pre.QUEST_RESP_RATING_SCORE}-Estrellas</Text>
              </View>
            </View>
          ))}
            <View style={styles.colums}>
            ...
            (c) => c.ANIO == anios && c.MANAGER_OR_SUBORD=="false"
              ...
              <View>
                <Text style={styles.txtBody}>
                <b>{pre.NOMBRE} {pre.APELLIDOS}</b><br/>{pre.QUESTION_RESP_COMMENT}
                </Text>
              </View>
          ))}
            </View>
