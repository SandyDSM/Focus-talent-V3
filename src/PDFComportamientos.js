        ...
        >
          ...
          <View style={styles.colums}>
            ...
            <View style={styles.rowsbetween}>
              <Text style={styles.txtBody}>Nombre completo del Jefe</Text>
              <View>
                <View
                  style={{
                    display:"flex",
                ...
                >
                  <Text style={styles.txtBody}>Estrellas</Text>
                </View>
              </View>
            </View>
            <View style={styles.colums}>
              ...
              <View>
                <Text style={styles.txtBody}>
                  Lorem ipsum dolor sit amet consectetur. Nunc cursus quis augue
                  id elementum bibendum. Tortor tristique viverra cursus duis
                  lacinia purus enim nisl at. Diam eu nec adipiscing fusce nunc.
                  Ac at in blandit adipiscing. Suspendisse consequat etiam
                  phasellus faucibus id rhoncus varius. Posuere ullamcorper
                  tincidunt felis tristique scelerisque fermentum.
                </Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.colums}>
            ...
            <View style={styles.rowsbetween}>
              <Text style={styles.txtBody}>
                Nombre completo del Colaborador 1
              </Text>
              <View>
                <Text style={styles.txtBody}>Estrellas</Text>
              </View>
