...
export default function TableEtiqueta(props) {
      ...
      >
        ...
        >
          ...
          <Text
            ...
            whiteSpace="pre-wrap"
            children="SPA"
            {...getOverrideProps(overrides, "Nombre35794394")}
          ></Text>
          <Text
            fontFamily="Inter"
            fontSize="14px"
            ...
            whiteSpace="pre-wrap"
            children="ENG"
            {...getOverrideProps(overrides, "Nombre35794395")}
          ></Text>
          <Text
            fontFamily="Inter"
            fontSize="14px"
            ...
            whiteSpace="pre-wrap"
            children="FRA"
            {...getOverrideProps(overrides, "Nombre35794396")}
          ></Text>
          <Text
            fontFamily="Inter"
            fontSize="14px"
            ...
            whiteSpace="pre-wrap"
            children="POR"
            {...getOverrideProps(overrides, "Nombre35794397")}
          ></Text>
          <Text
            fontFamily="Inter"
            fontSize="14px"
