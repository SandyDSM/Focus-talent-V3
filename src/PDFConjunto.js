...
const PDFConjunto = ({ DATOS, anios, datosUsuario, comportamientos }) => {
          ...
          {datComportaminetos?.filter(
            ...
            <View style={styles.columsBe}>
              ...
              <View style={styles.rowsGreyBe}>
                <Text style={styles.txtTitleBe}>Revisor</Text>
                <Text style={styles.txtTitleBe}>Clasificación</Text>
              </View>
              <View style={styles.rowsbetweenBe}>
                <Text
                  style={styles.txtBodyBe}
                ...
                <View>
                  ...
                  >
                    ...
                    <Text style={styles.txtBodyBe}></Text>
                  </View>
                </View>
              </View>
              <View style={styles.columsBe}>
                <Text style={styles.txtTitleBe}>Comentarios</Text>
                <View>
