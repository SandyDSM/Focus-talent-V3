          ...
          {anio < 2025 ? (
            ...
            >
              ...
              >
                <View style={styles.rowsBe}>
                  ...
                  <View style={styles.columsBe}>
                    ...
                    <View style={styles.rowsBe}>
                      ...
                      <Text style={styles.txtInfoBe}>
                        {datosUsuario.Organitation}
                      </Text>
                    </View>
                  </View>
                </View>
                <View style={styles.dividerBe}></View>
                {datComportaminetos
                  ?.filter(
                    (c) => c.ANIO == anio && c.MANAGER_OR_SUBORD == "true",
                  )
                  .map((pre) => (
                    <View>
                      <View style={styles.columsBe}>
                ...
                {datComportaminetos?.filter(
                  (c) => c.ANIO == anio && c.MANAGER_OR_SUBORD == "false",
                ) != 0 && (
                  <View style={styles.columsBe}>
                    <View style={styles.columsBe}>
                      <Text
                    ...
                    <View style={styles.columsBe}>
                      ...
                      {datComportaminetos
                        ?.filter(
                          (c) =>
                            c.ANIO == anio && c.MANAGER_OR_SUBORD == "false",
                        )
                        .map((pre) => (
                          <View>
                            <Text style={styles.txtTitleBe}>
            ...
            <Page size="A4">
              ...
              >
                ...
                {dataLiderazgo.filter(d => d.ANIO == anio).length > 0 ? (
                <>
                <View style={styles.titleContainer}>
                  <Text style={styles.title}>{etiquetas.califGeneral}</Text>
                  <Text style={styles.rating}>
                    {dataLiderazgo[0]?.RATING_ ?? "-"}
                  </Text>
                </View>
                ...
                <View style={styles.table}>
                  ...
                  <View style={[styles.row, styles.header]}>
                    ...
                    {encabezados.map((encabezado, i) => (
                      <Text key={i} style={styles.boldCell}>
                        {encabezado}
                      </Text>
                    ))}
                  </View>
                ...
                <View style={styles.feedbackContainer}>
                  <Text style={styles.feedbackTitle}>
                    {etiquetas.retroAlimentacion}
                  </Text>
                  {cmtLiderazgo?.map((dato, i) => (
                    <View key={i}>
                      <Text style={styles.feedbackText}>
                        {dato.ANSWER_ ?? "Sin respuesta"}
                      </Text>
                      {dato.SHOW_COMMENT === 1 && (
                        <Text style={[styles.feedbackText, { fontSize: 8 }]}>
                          {dato.RESPONDER ?? "-"}
                        </Text>
                      )}
                      <Text style={styles.feedbackTextMin}>
                        {dato.RESPONSIBLE_ ?? "-"}
                      </Text>
                    </View>
                  ))}
